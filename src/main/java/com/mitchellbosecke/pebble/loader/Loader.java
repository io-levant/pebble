...
public interface Loader<T> {
    ...
    /**
     * Returns {@code true} if the implementation is locale-aware, {@code false} otherwise
     * 
     * @return Returns {@code true} if the implementation is locale-aware, {@code false} otherwise
     */
    default boolean isLocaleAware() {
     ...
     *             If template can not be found
     */
    default Reader getReader(T cacheKey, final java.util.Locale locale) throws LoaderException {
     ...
     * @return Returns the cache key
     */
    default T createCacheKey(String templateName, final java.util.Locale locale) {
    	throw new UnsupportedOperationException();
    }
}